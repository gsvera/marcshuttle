        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Hotel / Airbnb</a>
                        <a class="collapse-item" href="#">Origenes</a>
                        <a class="collapse-item" href="#">Zonas</a>
                        <h6 class="collapse-header">Tours:</h6>
                        <a class="collapse-item" href="#">Vehiculos</a>
                        <a class="collapse-item" href="#">Tour</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseReports" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Bookings Trip</a>
                        <a class="collapse-item" href="#">Bookings Tours</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Huella-Digital 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
