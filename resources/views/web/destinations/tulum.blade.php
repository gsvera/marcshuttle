...
@section('metas')
    ...
    <meta name="title" content="{{__('Meta.tulum-title')}}">
    <meta name="description" content="{{__('Meta.tulum-descripcion')}}">
...
<script type="application/ld+json">
    {
        ...
        "mainEntity": [
            {
            "@type": "Question",
            "name": "{{__('Tulum.scritp-faq-question-uno')}}",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "{{__('Tulum.script-faq-answer-uno')}}"
            }
            },
            {
            "@type": "Question",
            "name": "{{__('Tulum.script-faq-question-dos')}}",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "{{__('Tulum.script-faq-answer-dos')}}"
            }
            },
            {
            "@type": "Question",
            "name": "{{__('Tulum.scritp-faq-question-tres')}}",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "{{__('Tulum.scritp-faq-answer-tres')}}"
            }
            },
            {
            "@type": "Question",
            "name": "{{__('Tulum.script-faq-question-cuatro')}}",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "{{__('Tulum.script-faq-answer-cuatro')}}"
            }
            },
            {
            "@type": "Question",
            "name": "{{__('Tulum.scritp-faq-question-cinco')}}",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "{{__('Tulum.script-faq-answer-cinco')}}"
            }
            }
        ]
    }
...
@section('content')
    <div class="layer-home back-slider-tulum"></div>
    ...
    <div>
        <div class="text-center" style="padding:50px 50px">
            <div class="ls2 font-weight-bold">{{__('Tulum.autobus-slogan')}}</div>
            ...
            <div class="row col-12 col-md-12 mt-5 mx-0 justify-content-center">
                <div class="col-12 col-md-3 p-2">
                    <div class="card-bus-blue text-center pt-3">
                        <h3 class="font-weight-bold text-white text-center">Toyota</h5>                                
    ...
    <div class="section">
        <div class="col-12 col-md-8 text-center mx-auto">
            <div class="text-blue ls2 font-weight-bold">{{__('Tulum.translados-slogan')}}</div>
            ...
            <div class="col-12 col-md-6">
                <div class="my-2">
                    ...
                    <div class="acord-faq" data-display="1">
                        <p class="text-justify text-gray">{{__('Tulum.faq-resp-uno')}}</p>
                ...
                <div class="my-2">
                    ...
                    <div class="acord-faq d-none" data-display="0">
                        <p class="text-justify text-gray">{{__('Tulum.faq-resp-dos')}}</p>
                        <p class="text-justify text-gray">{{__('Tulum.faq-resp-dos-dos')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
