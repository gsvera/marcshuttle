...
@section('metas')
    ...
    <meta name="title" content="{{__('Meta.playa-title')}}">
    <meta name="description" content="{{__('Meta.playa-descripcion')}}">
...
@section('content')
    ...
    <div>
        <div class="text-center" style="padding:50px 50px">
            <div class="ls2 font-weight-bold">{{__('Playa.autobus-slogan')}}</div>
